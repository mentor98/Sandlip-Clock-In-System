  ...
  approved_networks: [
    {
      ...
      label: 'Campus Designated WiFi Host (IP: 192.168.1.156)',
      mac_address: 'be:64:b4:14:4d:67',
      created_by: defaultAdminId,
      created_at: new Date().toISOString(),
    },
    {
      ...
      cidr: '192.168.1.0/24',
      label: 'Campus Subnet (192.168.1.0/24, AP MAC: BE:64:B4:14:4D:67)',
      mac_address: 'be:64:b4:14:4d:67',
      created_by: defaultAdminId,
      created_at: new Date().toISOString(),
    },
